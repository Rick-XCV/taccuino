...
- [HUGGINGFACE: Realtime dephtmap estimation](https://huggingface.co/spaces/Xenova/webgpu-realtime-depth-estimation)
- [CLAVICULA.LINK: Clavicula 3d](https://clavicula.link/)
- [YT: Acerola on Color Quantization and Dithering](https://www.youtube.com/watch?v=8wOUe32Pt-E)

## Audio, etc...
- [YT: A First Look At Raytraced Audio](https://www.youtube.com/watch?v=u6EuAUjq92k)
- [GITHUB: a long clap-plugins-list](https://github.com/RustoMCSpit/awesome-linux-clap-list)
